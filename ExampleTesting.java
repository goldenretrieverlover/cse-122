...
public class Testing {
    ...
    /* On this assignment, you are required to write 3 of your 
    own test cases for synchronize covering the different 
    LinkedList cases we've talked about in class: Front, 
    Middle, and Last. We've provided you two additional helper 
    methods to help in this process, as well as the 
    ExampleTesting.java to give you an idea of how to use them. 
    You are not required to write test cases for any of the 
    other instance methods for your Repository implementation, 
    but we'd encourage you do so to get more practice writing 
    JUnit tests.
